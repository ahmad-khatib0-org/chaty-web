import { RE_TIMESTAMP } from '@/components/markdown/plugins/timestamps'
import { RangeSetBuilder } from '@codemirror/state'
import { Decoration, DecorationSet, EditorView, ViewPlugin, ViewUpdate } from '@codemirror/view'

const spoilerMark = Decoration.mark({ class: 'cm-spoiler-mark' })

const spoilerTextMark = Decoration.mark({ class: 'cm-spoiler-text' })

const katexMark = Decoration.mark({ class: 'md-code' })

const timestampMark = Decoration.mark({ class: 'cm-timestamp md-code' })
