const RE_CHANNEL = /\/(channel|groups|saved-messages|direct)\/([A-Z0-9]{26})/
...
const RE_CHANNEL_EXACT =
  /^(?:\/server\/[A-Z0-9]{26})?\/(channel|groups|saved-messages|direct)\/([A-Z0-9]{26})(?:\/[A-Z0-9]{26})?$/
const RE_MESSAGE_ID_EXACT = /^(?:\/server\/[A-Z0-9]{26})?\/channel\/[A-Z0-9]{26}\/([A-Z0-9]{26})$/
 ...
 */
export function useSmartParams(): GlobalParams {
